...
/*     */ 
/*     */ public class QStockSumHistory extends com.querydsl.core.types.dsl.EntityPathBase<StockSumHistory>
/*     */ {
/*     */   private static final long serialVersionUID = 2050010059L;
/*  21 */   private static final PathInits INITS = new PathInits(new String[] { "*", "cargo.compartment.store.depot.*" });
/*     */   
/*  23 */   public static final QStockSumHistory stockSumHistory = new QStockSumHistory("stockSumHistory");
/*     */   
...
/*     */   
/*     */   public QStockSumHistory(String variable) {
/* 236 */     this(StockSumHistory.class, com.querydsl.core.types.PathMetadataFactory.forVariable(variable), INITS);
/*     */   }
/*     */   
/*     */   public QStockSumHistory(Path<? extends StockSumHistory> path) {
/* 240 */     this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
/*     */   }
/*     */   
/*     */   public QStockSumHistory(PathMetadata metadata) {
/* 244 */     this(metadata, PathInits.getFor(metadata, INITS));
/*     */   }
/*     */   
/*     */   public QStockSumHistory(PathMetadata metadata, PathInits inits) {
/* 248 */     this(StockSumHistory.class, metadata, inits);
/*     */   }
/*     */   
/*     */   public QStockSumHistory(Class<? extends StockSumHistory> type, PathMetadata metadata, PathInits inits) {
...
/* Location:              C:\Users\10231\Desktop\shundedapingtai\grm\WEB-INF\classes\!\com\haut\grm\model\business\QStockSumHistory.class
