...
@Projection(name="detail", types={Store.class})
public abstract interface StoreDetail
{
  ...
  public abstract StoreConfigDetail getConfig();
  
  public abstract StoreStatusDetail getStatus();
}


/* Location:              C:\Users\10231\Desktop\shundedapingtai\grm\WEB-INF\classes\!\com\haut\grm\model\StoreDetail.class
