...
public class GrmProcessDiagramCanvas {
    protected static final Logger LOGGER = LoggerFactory.getLogger(GrmProcessDiagramCanvas.class);
    ...
    static {
        ...
        LABEL_COLOR = new Color(14, 80, 165);
    ...
    public GrmProcessDiagramCanvas(int width, int height, int minX, int minY, String imageType, String activityFontName, String labelFontName, String annotationFontName, ClassLoader customClassLoader) {
    ...
    public GrmProcessDiagramCanvas(int width, int height, int minX, int minY, String imageType) {
        this.canvasWidth = width;
        this.canvasHeight = height;
        this.minX = minX;
        this.minY = minY;
    ...
    protected void drawMultilineText(String text, int x, int y, int boxWidth, int boxHeight, boolean centered) {
        ...
        for(Iterator var17 = layouts.iterator(); var17.hasNext(); currentY = (int)((float)currentY + textLayout.getDescent() + textLayout.getLeading())) {
            textLayout = (TextLayout)var17.next();
    ...
    public List<GraphicInfo> connectionPerfectionizer(GrmProcessDiagramCanvas.SHAPE_TYPE sourceShapeType, GrmProcessDiagramCanvas.SHAPE_TYPE targetShapeType, GraphicInfo sourceGraphicInfo, GraphicInfo targetGraphicInfo, List<GraphicInfo> graphicInfoList) {
    ...
    private static Shape createShape(GrmProcessDiagramCanvas.SHAPE_TYPE shapeType, GraphicInfo graphicInfo) {
        if (GrmProcessDiagramCanvas.SHAPE_TYPE.Rectangle.equals(shapeType)) {
            return new java.awt.geom.Rectangle2D.Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight());
        } else if (GrmProcessDiagramCanvas.SHAPE_TYPE.Rhombus.equals(shapeType)) {
            ...
            return GrmProcessDiagramCanvas.SHAPE_TYPE.Ellipse.equals(shapeType) ? new Double(graphicInfo.getX(), graphicInfo.getY(), graphicInfo.getWidth(), graphicInfo.getHeight()) : null;
        }
    }
