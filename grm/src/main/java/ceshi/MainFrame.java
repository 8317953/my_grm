...
public class MainFrame extends JFrame {
    ...
    public static void main(String[] args) {
    	File file =new File ("D:\\opencv4.1\\opencv\\build\\x64\\vc12\\lib");
...
//        System.out.println(frame.dtriangles.triangles.size());
//        
//        for(mTriangle m:frame.dtriangles.triangles) {
//        	System.out.println("["+m.a.x+","+m.a.y+","+0+"],["+m.b.x+","+m.b.y+","+0+"],["+m.c.x+","+m.c.y+","+0+"]");
//        }
//
//    }
}
