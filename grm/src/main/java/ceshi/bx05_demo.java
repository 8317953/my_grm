...
//    }
    ...
    // 将一个节目发送到控制器上并显示
    public static void SendProgram(String mytext)throws Exception
    {
        // 关于显示特技
        // 0:随机显示
        // 1:静止显示
...
//        ControllerConfigFile myconFile= screen.readConfig();
//        System.out.println("--------------------------");
//        System.out.println(Arrays.toString(myconFile.getAddress()));  //[11,2]
//        
//        System.out.println(myconFile.getBaudrate());//2
//        
//        System.out.println(myconFile.getCascadeMode());//0
//        
//        System.out.println(myconFile.getColor());//3
//        
//        System.out.println(myconFile.getCommTimeoutValue());//17
//        
//        System.out.println(myconFile.getControllerName());//LED00523
//        
//        System.out.println(myconFile.getDaPol());//1
//        
//        System.out.println(myconFile.getFaultProcessMode());//0
//
//        System.out.println(myconFile.getFreqPar());//3
//        System.out.println(myconFile.getGrayFlag());//0
//        
//        System.out.println(myconFile.getLoggingMode());//0
//        System.out.println(myconFile.getMirrorMode());//0
//        
//        System.out.println(myconFile.getOeAngle());//0
//        
//        System.out.println(myconFile.getOePol());//0
//        
//        System.out.println(myconFile.getOeWidth());//12
//        
//        System.out.println(myconFile.getRowOrder());//0
//        
//        System.out.println(myconFile.getRunningMode());//0
//        
//        System.out.println(myconFile.getScreenHeight());//32
//        
//        System.out.println(myconFile.getScreenWidth());//128
//        
//        System.out.println(Arrays.toString(myconFile.getBackup()));//[0, 0, 0, 0, 0, 0]
        
        byte[] backup=new byte[6];
...
//        bxFile.setScreenWidth(128*2);
//        bxFile.setScreenHeight(32*2);
//        bxFile.setDaPol(daPol);
//        bxFile.setLoggingMode(1);
      ...
      bxFile.setAddress(myaddress);  //[11,2]
      
      bxFile.setBaudrate(2);//2
      
      bxFile.setCascadeMode(0);//0
      
      bxFile.setColor(3);//3
      
      bxFile.setCommTimeoutValue(17);//17
      
      bxFile.setControllerName("LED00523");//LED00523
      
      bxFile.setDaPol(1);//1
      
      bxFile.setFaultProcessMode(0);//0

      bxFile.setFreqPar(3);//3
      bxFile.setGrayFlag(0);//0
      
      bxFile.setLoggingMode(0);//0
      bxFile.setMirrorMode(0);//0
      
      bxFile.setOeAngle(0);//0
      
      bxFile.setOePol(0);//0
      
      bxFile.setOeWidth(12);//12
      
      bxFile.setRowOrder(0);//0
      
      bxFile.setRunningMode(0);//0
      
      bxFile.setScreenHeight(32);//32
      
      bxFile.setScreenWidth(128);//128
      
      bxFile.setBackup(backup);//[0, 0, 0, 0, 0, 0]
...
//        }
        ...
        // 注意区域坐标和宽度高度，不要越界
        TextCaptionBxArea area = new TextCaptionBxArea( 0,0,128,32,screen.getProfile() );

        // 创建一个数据页
        // 第一行数据
        TextBxPage page = new TextBxPage(mytext);
        // 第二行数据
//        page.newLine( "这是第二行" );
        // 设置字体
...
//        Alignment align=
        page.setHorizontalAlignment(Alignment.NEAR);//水平居中      //near  左上角
        page.setVerticalAlignment(Alignment.NEAR);//竖直居中
        // 设置显示特技为快速打出
