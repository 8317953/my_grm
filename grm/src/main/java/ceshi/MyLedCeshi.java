...
public class MyLedCeshi implements  BxFileWriterListener<Bx5GScreen>  {
	/**
     * Demo code.
     * @param args Ignore
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 端口号默认为 5005
        if (!screen.connect("192.168.0.199", 5005)) {
        ...
        System.out.println("screen width : " + profile.getWidth());
        System.out.println("screen height : " + profile.getHeight());
...
//        Bx5GScreenProfile profile = screen.getProfile();
//        org.apache.log4j.Logger.getLogger(MyLedCeshi.class).info("screen width : " + profile.getWidth());
//        org.apache.log4j.Logger.getLogger(MyLedCeshi.class).info("screen height : " + profile.getHeight());
